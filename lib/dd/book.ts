export interface DDChapter {
  ...
  // Maps a curated chapter slug to its source manuscript chapter (book.md
  // "# CHAPTER N"). Omit when the curated chapter has no manuscript content
  // yet — the reader will see a "Coming soon" placeholder.
  manuscriptChapter?: number
}
...
export const DD_CHAPTERS: DDChapter[] = [
  ...
  { slug: 'gray-man', number: 4, title: 'The Gray Man', subtitle: 'Capability Without Spectacle', tier: 'builder', section: 'foundation', manuscriptChapter: 11 },
  ...
  { slug: 'fate-overview', number: 6, title: 'The FATE Model', subtitle: 'Food, Assurance, Tools & Skills, Energy', tier: 'free', section: 'fate', manuscriptChapter: 9 },
  { slug: 'fate-food', number: 7, title: 'F — Food', subtitle: 'Caloric Independence and the Feeding Chain', tier: 'builder', section: 'fate', manuscriptChapter: 15 },
  ...
  { slug: 'fate-tools-skills', number: 9, title: 'T — Tools & Skills', subtitle: 'Knowledge That Lives in Hands', tier: 'builder', section: 'fate', manuscriptChapter: 20 },
  { slug: 'fate-energy', number: 10, title: 'E — Energy', subtitle: 'Power, Water, Heat — The Infrastructure of Life', tier: 'builder', section: 'fate', manuscriptChapter: 12 },
  ...
  { slug: 'dead-zombie-living', number: 12, title: 'Dead, Zombie, and Living Preps', subtitle: 'Classifying What You Have', tier: 'free', section: 'preps', manuscriptChapter: 3 },
  ...
  { slug: 'the-living-system', number: 14, title: 'The Living System', subtitle: 'Maintenance as a Household Practice', tier: 'builder', section: 'preps', manuscriptChapter: 10 },
  { slug: 'dynasty-wealth', number: 15, title: 'Dynasty Wealth', subtitle: 'Financial Independence as Household Sovereignty', tier: 'builder', section: 'preps', manuscriptChapter: 23 },
  { slug: 'energy-independence', number: 16, title: 'Energy Independence', subtitle: 'Building Off the Grid, Step by Step', tier: 'steward', section: 'preps', manuscriptChapter: 13 },
  { slug: 'medical-assurance', number: 17, title: 'Medical Assurance', subtitle: 'First Responder in Your Own Home', tier: 'steward', section: 'preps', manuscriptChapter: 18 },
  { slug: 'skills-over-gear', number: 18, title: 'Skills Over Gear', subtitle: 'Why What You Know Outlasts What You Own', tier: 'builder', section: 'preps', manuscriptChapter: 22 },
  ...
  { slug: 'quiet-mutual-aid', number: 22, title: 'Quiet Mutual Aid', subtitle: 'Helping Without Creating Dependency', tier: 'steward', section: 'long-table', manuscriptChapter: 26 },
  { slug: 'civic-extension', number: 23, title: 'Civic Extension', subtitle: 'Sheriff, School Board, and the Institutions That Matter', tier: 'steward', section: 'long-table', manuscriptChapter: 25 },
  { slug: 'regional-foundation', number: 24, title: 'Regional Foundation', subtitle: 'The Outermost Ring of Dynasty Impact', tier: 'steward', section: 'long-table', manuscriptChapter: 27 },
  ...
  // SECTION V — THE VOW
  { slug: 'forging-fathers', number: 26, title: 'Forging Fathers', subtitle: 'The Legacy Protocol', tier: 'steward', section: 'vow', manuscriptChapter: 5 },
  ...
  { slug: 'the-vow-ceremony', number: 28, title: 'The Vow', subtitle: 'A Formal Commitment to Dynastic Stewardship', tier: 'steward', section: 'vow', manuscriptChapter: 28 },
]
